<?php
  $NIOS_baseURL="https://10.60.32.55/wapi/v2.6/";
  $NIOS_User="admin";
  $NIOS_PWD="InfobloxR7";
...
//         [call=>"extensibleattributedef",
//         data=>[name=>"R7_NetToSite", comment=>"R7 Add a network to a site", type=>"ENUM", flags=>"I", default_value=>"true", list_values=>[[value=>"true"],[value=>"false"]],allowed_object_types=>["Network","IPv6Network","NetworkView"]]],

//         [call=>"extensibleattributedef",
//         data=>[name=>"R7_RangeToSite", comment=>"R7 Add a range to a site", type=>"ENUM", flags=>"I", default_value=>"true", list_values=>[[value=>"true"],[value=>"false"]],allowed_object_types=>["Network","DhcpRange","IPv6Network","IPv6DhcpRange","NetworkView"]]],
